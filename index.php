                ...
                <div class="row height align-items-center">
                    <div class="col-lg-7">
                        <div class="banner-content">
                            <h1 class="text-white text-center text-uppercase mb-10">Запусти свою социальную сеть сегодня <br> или присоединяйся к команде разработчиков</h1>
                            <p class="text-white text-center mb-30">Принимай непосредственное участие в том, как ты хочешь общаться в сети.</p>
                            <a href="./get-started.php" class="primary-btn d-inline-flex align-items-center"><span class="mr-10">Начать</span><span class="lnr lnr-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="main-wrapper">
    <div class="working-process-area">
        <div class="container">
            <div class="row justify-content-center"о
            <div class="col-lg-6">
                <div class="section-title text-center">
                    <h2>Процесс</h2>
                    <p>Социальная сеть является открытом проектом распостраняющеся по лицензии Open Source. Любой желающий может скачать и установить ее у себя на своем хостинге, а также стать разработчиком, уже существующей развернутой платформы по адресу http://onoffline.ru</p>
                </div>
            </div>
        </div>
        <div class="total-work-process d-flex flex-wrap justify-content-around align-items-center">
            ...
            <div class="single-work-process">
                ...
                <h4 class="caption">2. Установи</h4>
            </div>
            <div class="work-arrow">
                <img src="img/elements/work-arrow.png" alt="">
            </div>
            <div class="single-work-process">
                ...
                <h4 class="caption">3. Пользуйся</h4>
            </div>
            <div class="work-arrow">
                <img src="img/elements/work-arrow.png" alt="">
            </div>
            <div class="single-work-process">
                ...
                <h4 class="caption">4. Наслаждайся</h4>
            </div>
        </div>
    </div>
</div>
    ...
    <section class="featured-area">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        <h2 class="text-white">Возможности социальной сети на сегодня</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="single-feature">
                        <div class="desc mt-30">
                            <h4 class="text-white">Регистрация пользователей.</h4>
                            <h4 class="text-white">Редактирование профайла.</h4>
                            <h4 class="text-white">Добавление фотографий.</h4>
                            <h4 class="text-white">Добавление видео с Youtube.</h4>
                            <h4 class="text-white">Общение</h4>
                            <h4 class="text-white">Стена</h4>
                            <h4 class="text-white">И многое другое...</h4>
                        </div>
                    </div>
                </div>
                <!--div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="single-widget">
                        <div class="desc">
                            ...
                            <div class="contact">
                                <a href="mailto:suppurt@onoffline.ru">support@onoffline.ru</a> <br>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer>
            <div class="container">
                <div class="footer-content d-flex justify-content-between align-items-center flex-wrap">
                    <div class="logo">
                        <a href="./" style="color:white;font-weight:bold;font-style:italic;font-size:24px;">ONOFFLINE</a>
                    </div>
                    <div class="copy-right-text">Copyright &copy; 2018 </div>
